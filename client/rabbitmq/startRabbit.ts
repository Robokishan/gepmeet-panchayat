import { startRabbit, HandlerMap } from '.';
import { closePeer } from '../../helper/mediasoup';
import { createRoom } from '../../helper/mediasoup/createRoom';
import { deleteRoom } from '../../helper/mediasoup/deleteRoom';
import { MyRooms } from '../../helper/MyRoomState';
import Logger from '../../utils/logger';
import { createConsumer } from '../mediasoup/createConsumer';
import {
  createTransport,
  transportToOptions
} from '../mediasoup/createTransport';

const rooms: MyRooms = {};

export const startRabbitServer = async () => {
  ...
  await startRabbit({
    ...
    ['join-as-speaker']: async ({ roomId, peerId }, uid, send) => {
      ...
      log.info('join-as-new-peer', peerId);
